...
# --- 关键查询 ---
query_expr = f'doc_id == "578f3b5db32dec7185d0f77bedc2d967_13"'

# 查询1：只请求显式的 metadata 字段
print("--- 查询1: 只请求 'metadata' 字段 ---")
results1 = collection.query(expr=query_expr, output_fields=["metadata"])
print(results1)
# # --- 辅助函数 ---
# # 这是唯一需要修改的函数
#
...
#
#     metadata_patch= {
#         "416119751824d7ad81dae3201d6eaec5_0": {
#             "file_name": "AB",
#         },
